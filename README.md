...
<p align="left">
  <a href="#">
    <img src="https://img.shields.io/badge/SEGA-Mega%20Drive %20%2F%20 Genesis-0160B4" alt="SEGA">
  </a>
  <a href="#">
...
<p align="left">
  <b>MegaROMizer</b> — умный сортировщик ROM'ов для SEGA Mega Drive / Genesis с автоматическим отбором<br> 
  лучших ревизий, интуитивно понятным интерфейсом, собственной базой данных и 17 вариантами сборки.<br> 
...
### 📌 Варианты сборки
- **Три типа сборки:** `[FULL] ПОЛНАЯ КОЛЛЕКЦИЯ`, `[1G1R] 1 РОМ - 1 ИГРА`, `[2P] НА ДВОИХ`
