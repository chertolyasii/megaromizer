...
<p align="left">
  ...
  <a href="#"><img src="https://img.shields.io/badge/Форматы-.bin%20.gen%20.md%20.smd%20.7z%20.zip%20.rar-orange" alt="Formats"></a>
</p>
...
<!-- СКРИНШОТ -->
<p align="center">
  <img src="docs/main_window_v1.5.0.png" alt="Главное окно MegaROMizer" width="80%">
</p>
...
- **Поддерживаемые форматы:** `.bin`, `.gen`, `.md`, `.smd`, `.sms*`, `.7z`, `.zip`, `.rar`
...
**Статистика базы данных (v160):**
- Позиций: 1115 (ROM'ов: 3384)
  - Офиц. на картриджах: 895 (1440)
  - Офиц. встроенные: 56 (85)
  - Офиц. цифровые: 78 (86)
  - Нелицензионные: 88 (116)
  - Пиратские: 59 (66)
  - Прототипы: 80 (93)
  - Переиздания: 109 (150)
  - Beta-версии: 264 (695)
...
- 👁️ **Предпросмотр** — показывает состав сборки без копирования файлов (кнопка `👁️`), а также недостающие в коллекции ROM'ы (с учётом выбранных фильтров) и иную статистическую информацию
