...
Пробная версия позволяет использовать весь функционал для **64 случайных игр** из вашей коллекции.<br> 
Таким образом, каждая пробная сборка в одном и том же режиме может отличаться от предыдущей.
