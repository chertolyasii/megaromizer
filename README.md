...
<p align="left">
  ...
  и сделает всю работу за тебя:
   ...
   <br> • разложит игры по папкам типа мультиплеера, жанров и алфавита
</p>
...
<!-- СКРИНШОТ -->
<p align="center">
  <img src="docs/main_window_v1.3.0.png" alt="Главное окно MegaROMizer" width="80%">
</p>
...
Файл `mrzr_base.dat` содержит информацию о **всех официальных играх SEGA Mega Drive / Genesis** (877), выпущенных на картриджах в **1988–1998 гг.**:

- ✅ Все региональные версии и ревизии
- ✅ Уникальная жанровая классификация
- ✅ Типы мультиплеера для 452 игр (Co-op, PvP, Turn-base, Hot-seat)
- ✅ Русские переводы для 290 игр

📊 **Всего:** 1980 версий ROM'ов с учётом регионов, ревизий и переводов.
...
| `enable_russian` | Включить версии с русским переводом (`true`/`false`) |
...
- **Возможность использовать версии игр с русским переводом**
